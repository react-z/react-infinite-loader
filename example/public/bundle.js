...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* import InfiniteLoader from '../lib/InfiniteLoader' */
	...
	var ArticlesList = function (_Component) {
	  ...
	  function ArticlesList() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ArticlesList).apply(this, arguments));
	  }
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    fetchFeed: function (_fetchFeed) {
	      function fetchFeed(_x) {
	        return _fetchFeed.apply(this, arguments);
	      }
	
	      fetchFeed.toString = function () {
	        return _fetchFeed.toString();
	      };
	
	      return fetchFeed;
	    }(function (section) {
	      return dispatch(fetchFeed(section));
	    }),
	    feedViewed: function (_feedViewed) {
	      function feedViewed() {
	        return _feedViewed.apply(this, arguments);
	      }
	
	      feedViewed.toString = function () {
	        return _feedViewed.toString();
	      };
	
	      return feedViewed;
	    }(function () {
	      return dispatch(feedViewed());
	    })
	  };
	};
	
	var FeedContainer = function (_Component2) {
	  _inherits(FeedContainer, _Component2);
	
	  function FeedContainer() {
	    _classCallCheck(this, FeedContainer);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(FeedContainer).apply(this, arguments));
	  }
	
	  _createClass(FeedContainer, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var feedViewed = this.props.feedViewed;
	    }
	  }, {
	    key: '_renderArticle',
	    value: function _renderArticle(article, section) {
	      return _react2.default.createElement(ArticleCard, { key: 'feed_' + article.article_id, article: article });
	    }
	  }, {
	    key: '_fetch',
	    value: function _fetch(page) {
	      var fetchFeed = this.props.fetchFeed;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(ArticlesList, { ref: 'articles', articles: feed, renderArticle: this._renderArticle, fetch: this._fetch.bind(this) })
	      );
	    }
	  }]);
	...
	var Counter = function (_Component3) {
	  _inherits(Counter, _Component3);
	  ...
	  _createClass(Counter, [{
	    ...
	    value: function render() {
	      ...
	      var onIncrement = _props2.onIncrement;
	      var onDecrement = _props2.onDecrement;
